...
const config = {
  ...
  pages: {
    ...
    "account-research-module-build-vs-buy": {
      ...
      cardExcerpt: "Native config, AppExchange, custom Salesforce module, or fully custom CRM — four options with very different total cost of ownership. Plus a fifth option changing the calculus. A decision framework based on 3-year TCO.",
      cardMeta:    "12 min read · CTO · VP Sales · RevOps",
      category:    "dec",
      roles:       "cto vps rvp ceo",
      tldr: [
        "The right answer depends on three variables: how differentiated your research process actually is, what your internal technical capacity to maintain a build looks like, and three-year total cost of ownership — not year-one cost.",
        "AppExchange tools carry three underestimated risks: data residency and compliance exposure from enrichment data flows, sync reliability that degrades silently over time, and switching costs higher than they appear after 18 months of enrichment.",
        "A custom Salesforce module is a maintain-forever commitment, not a build-once asset. Salesforce's three annual platform releases regularly break custom Apex code — budget ongoing developer time from day one.",
        "A fully custom CRM is a product, not a project. Most organisations that choose it underestimate the perpetual engineering ownership required. The question is not whether you could build something better — you could — but whether your process is differentiated enough to justify owning a CRM indefinitely.",
        "AI-native research tools have emerged as a credible fifth option, delivering synthesised pre-call intelligence that previously required a custom build. Run a 30-day pilot before concluding custom is necessary.",
      ],
      title:       "Build, Buy or Configure? Choosing the Right Account Research Module | GoWarm Insights",
      description: "Should you configure Salesforce natively, install an AppExchange tool, build a custom Salesforce module, or move to a fully custom CRM? A decision framework covering all four options plus AI-native tools, based on total cost of ownership rather than build cost alone.",
      ...
      faqs: [
        { q: "Should I build a custom CRM or use Salesforce?",
          a: "A custom CRM is the right answer in a narrow set of circumstances: your sales process has proprietary logic no commercial CRM can accommodate, you have an engineering team that can own the platform indefinitely, and you have validated through rigorous commercial evaluation that existing platforms genuinely cannot meet your requirements. Most organisations that choose custom builds underestimate the perpetual engineering commitment. The question is not whether you could build something better — you could — but whether your process is differentiated enough to justify owning a CRM as a product indefinitely." },
        { q: "What are the risks of using an AppExchange tool for CRM enrichment?",
          a: "Three risks are consistently underweighted: data residency and compliance exposure from enrichment data flows (the vendor's DPA covers their processing, not what you do with the data in your org); sync reliability that degrades silently over time as both platforms update independently; and switching costs that are higher than they appear after 18 months of enrichment, since the vendor's proprietary database data does not transfer when you change vendors." },
        { q: "When does it make sense to build a custom module inside Salesforce?",
          a: "When your research process is genuinely differentiated — specific data sources, proprietary scoring models, industry-specific signals — and you have internal Salesforce development capacity that can maintain the code across Salesforce's three annual platform releases. Each release can break custom Apex code. A custom Salesforce module requires ongoing developer time to stay current, not just initial build time." },
        { q: "What are AI-native CRM research tools?",
          a: "AI-native research tools use large language models to synthesise account intelligence from multiple sources in real time, producing structured pre-call briefs rather than simply populating fields from a static enrichment database. Several capabilities that previously required a custom build can now be delivered by AI-native tools without the engineering commitment. The category is evolving quickly — a structured 30-day pilot with real reps on real accounts is the right evaluation method before any commitment." },
      ],
    },
    ...
    "pricing-approval-workflow-crm": {
      ...
      cardLabel:   "CRM Architecture",
      cardExcerpt: "Native Salesforce handles most pricing approval use cases without additional tooling. Here is how to know if your situation is in that majority — and which option is right if it is not.",
      cardMeta:    "11 min read · VP Sales · RevOps · CTO",
      category:    "dec",
      roles:       "cto vps rvp ceo",
      tldr: [
        "Most organisations over-engineer pricing approval. Native Salesforce approval processes handle the majority of use cases — multi-step approval chains, conditional entry criteria, complete audit trail — without any additional tooling or cost.",
        "CPQ tools are justified when your quoting process is complex (bundling, configuration rules, volume pricing). They are not justified when your requirement is specifically about discount governance on a straightforward product set.",
        "Pricing approval audit trails have downstream commercial and legal significance. Check that wherever your approval records live, they are immutable after the decision is made — not all external tools guarantee this.",
        "Before evaluating any tool: write your approval trigger conditions, approval chain, and approver roles on one page. Most organisations discover at this stage that native Salesforce is sufficient — and skip this step, buying complexity they did not need.",
      ],
      ...
      schema:      "Article",
      faqs: [
        { q: "Can Salesforce handle pricing approval workflows natively?",
          a: "Yes, for the majority of use cases. Salesforce's built-in approval process engine supports multi-step approvals, conditional entry criteria, multiple approvers at each step, parallel approval tracks, email and Chatter notifications, and a complete immutable audit history. It is configurable by an admin without custom code. The limits appear with highly conditional routing, dynamic approver assignment, or approvers without Salesforce licences — though email-based approval actions allow non-Salesforce users to approve or reject via email reply." },
        { q: "When do you need CPQ for pricing approval?",
          a: "CPQ is justified when the approval workflow is inseparable from a complex quoting problem: a large product catalogue with bundling logic, configuration rules, and volume pricing that need to be enforced before a quote reaches the approval stage. If your quoting process is straightforward — a defined product set with standard pricing and a discount threshold — CPQ is disproportionate for the approval requirement alone." },
        { q: "What are the audit trail requirements for pricing approval?",
          a: "Pricing approval records have downstream commercial and sometimes legal significance as evidence that a discount was authorised by the right person. The audit trail needs to be immutable (approval decisions not editable after the fact), accessible to finance and legal without requiring Salesforce access, and retained for the appropriate period. Native Salesforce approval history is immutable by design. External tools may have different guarantees — check this explicitly before committing." },
        { q: "Should pricing approval be built as a custom module in Salesforce?",
          a: "Only when native Salesforce approval processes genuinely cannot express your logic — highly conditional routing based on multiple deal attributes, dynamic approver calculation, or deep ERP integration requirements. Custom approval modules are maintenance-intensive because approval logic changes frequently as discount policy evolves, and because Salesforce's three annual platform releases can affect Flow and Process Builder behaviour. Build in Flow rather than Apex where possible to reduce migration risk from deprecated automation tools." },
      ],
    },
